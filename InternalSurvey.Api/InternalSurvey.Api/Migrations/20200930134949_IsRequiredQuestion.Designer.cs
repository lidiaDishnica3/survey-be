...
namespace InternalSurvey.Api.Migrations
{
    ...
    [Migration("20200930134949_IsRequiredQuestion")]
    partial class IsRequiredQuestion
    {
            ...
            modelBuilder.Entity("InternalSurvey.Api.Entities.AspNetUsers", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2020, 9, 30, 15, 49, 48, 658, DateTimeKind.Local).AddTicks(3417),
