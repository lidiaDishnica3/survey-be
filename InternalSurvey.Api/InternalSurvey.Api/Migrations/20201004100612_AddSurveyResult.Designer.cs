...
namespace InternalSurvey.Api.Migrations
{
    ...
    [Migration("20201004100612_AddSurveyResult")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InternalSurvey.Api.Entities.AspNetUsers", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2020, 10, 4, 12, 6, 12, 62, DateTimeKind.Local).AddTicks(6532),
            ...
            modelBuilder.Entity("InternalSurvey.Api.Entities.SurveyResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InternalSurvey.Api.Entities.Response", b =>
                {
                    ...
                    b.HasOne("InternalSurvey.Api.Entities.SurveyResult", "SurveyResult")
                        .WithMany()
