...
namespace InternalSurvey.Api.Migrations
{
    ...
    [Migration("20200928144818_NewAttributeQuestion")]
    partial class NewAttributeQuestion
    {
            ...
            modelBuilder.Entity("InternalSurvey.Api.Entities.AspNetUsers", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2020, 9, 28, 16, 48, 17, 777, DateTimeKind.Local).AddTicks(383),
