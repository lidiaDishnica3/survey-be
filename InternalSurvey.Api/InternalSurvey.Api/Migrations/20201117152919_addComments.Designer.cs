...
namespace InternalSurvey.Api.Migrations
{
    ...
    [Migration("20201117152919_addComments")]
            ...
            modelBuilder.Entity("InternalSurvey.Api.Entities.AspNetUsers", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "023168dc-35d5-45de-b757-62f544cb6a92",
                            CreatedBy = "atisadmin@atis.al",
                            CreatedOn = new DateTime(2020, 11, 17, 16, 29, 18, 674, DateTimeKind.Local).AddTicks(4638),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEMpfhd+NM76ChIN4Kpb27ECxxURQ5HggRhfqEWy022NwP61xZT6KAvAYT08oSsks0w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "23b1a109-bf36-4e7a-8f40-dd7762341d49",
                            TwoFactorEnabled = false,
                            UserName = "atisadmin@atis.al"
                        });
                });

            modelBuilder.Entity("InternalSurvey.Api.Entities.Comment", b =>
                {
            ...
            modelBuilder.Entity("InternalSurvey.Api.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("InternalSurvey.Api.Entities.Survey", null)
                        .WithMany("Comments")
