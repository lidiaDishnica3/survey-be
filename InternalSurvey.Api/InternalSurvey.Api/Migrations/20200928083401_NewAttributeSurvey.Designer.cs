...
namespace InternalSurvey.Api.Migrations
{
    ...
    [Migration("20200928083401_NewAttributeSurvey")]
    partial class NewAttributeSurvey
    {
            ...
            modelBuilder.Entity("InternalSurvey.Api.Entities.AspNetUsers", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2020, 9, 28, 10, 34, 1, 209, DateTimeKind.Local).AddTicks(749),
