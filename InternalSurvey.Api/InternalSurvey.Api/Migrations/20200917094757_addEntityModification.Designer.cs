...
namespace InternalSurvey.Api.Migrations
{
    ...
    [Migration("20200917094757_addEntityModification")]
    partial class addEntityModification
    {
            ...
            modelBuilder.Entity("InternalSurvey.Api.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2020, 9, 17, 11, 47, 56, 958, DateTimeKind.Local).AddTicks(8654),
