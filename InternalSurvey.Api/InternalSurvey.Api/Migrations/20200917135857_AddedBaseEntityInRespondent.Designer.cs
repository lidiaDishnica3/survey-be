...
namespace InternalSurvey.Api.Migrations
{
    ...
    [Migration("20200917135857_AddedBaseEntityInRespondent")]
    partial class AddedBaseEntityInRespondent
    {
            ...
            modelBuilder.Entity("InternalSurvey.Api.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2020, 9, 17, 15, 58, 57, 25, DateTimeKind.Local).AddTicks(2736),
